      ...
      >
        <div className="container">
          <Link className="navbar-brand d-flex align-items-center text-decoration-none gap-2" to="/car-spa">
            <img src={logoImg} alt="Cleanz24" className="me-1 navbar-logo" style={{ height: isScrolled ? '52px' : '65px', transition: 'height 0.4s ease' }} />
          ...
          <div className="collapse navbar-collapse justify-content-end" id="mynavbar">
            <div className="navbar-nav align-items-center">
              ...
              <Link className={`nav-link text-heading mx-3 fw-medium hover-brand ${isActive('/car-spa/services') ? 'active-link' : ''}`} to="/car-spa/services">Services</Link>
              
              {/* Packages Dropdown */}
              <div className="nav-item dropdown mx-2" style={{ position: 'relative' }}>
                <button 
              ...
              <Link className={`nav-link text-heading mx-3 fw-medium hover-brand ${isActive('/car-spa/franchise') ? 'active-link' : ''}`} to="/car-spa/franchise">Franchise</Link>
              
              {/* Back to Home Link */}
              <Link className="nav-link text-heading mx-3 fw-medium hover-brand" style={{ color: 'var(--accent-color)' }} to="/">
                ← Back to Home
              </Link>
