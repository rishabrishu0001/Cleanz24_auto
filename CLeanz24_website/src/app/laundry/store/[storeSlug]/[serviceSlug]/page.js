...
export async function generateMetadata({ params }) {
  ...
  const url = `https://cleanz24.com/laundry/store/${storeSlug}/${serviceSlug}`;
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 2,
            name: 'Stores',
            item: 'https://cleanz24.com/laundry/stores'
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: storeName,
            item: `https://cleanz24.com/laundry/store/${storeSlug}`
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: serviceName,
            item: `https://cleanz24.com/laundry/store/${storeSlug}/${serviceSlug}`
          }
        ]
      },
      {
    ...
    <div className="city-service-wrapper">
      ...
      <section className="city-service-hero">
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <nav style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '20px' }}>
            ...
            <Link href="/laundry/stores" style={{ color: '#16a34a', textDecoration: 'none', fontWeight: '500' }}>Stores</Link>
            <span style={{ margin: '0 8px' }}>›</span>
            <Link href={`/laundry/store/${storeSlug}`} style={{ color: '#16a34a', textDecoration: 'none', fontWeight: '500' }}>{storeName}</Link>
            <span style={{ margin: '0 8px' }}>›</span>
      ...
      <section className="city-service-footer">
        <p style={{ fontSize: '0.95rem' }}>
          Back to the dedicated <Link href={`/laundry/store/${storeSlug}`} style={{ color: '#16a34a', fontWeight: '600', textDecoration: 'none' }}>Cleanz24 {storeName} Page</Link>
        </p>
      </section>
    </div>
  );
