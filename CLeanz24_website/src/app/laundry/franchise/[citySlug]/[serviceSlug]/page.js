...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://cleanz24.com/laundry/franchise/${citySlug}/${serviceSlug}`,
    },
    openGraph: {
      title: pageTitle,
      description: pageDesc,
      url: `https://cleanz24.com/laundry/franchise/${citySlug}/${serviceSlug}`,
      siteName: 'Cleanz24',
      type: 'website',
      images: [
        {
    ...
    '@graph': [
      {
        '@type': 'BreadcrumbList',
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Home', 'item': 'https://cleanz24.com/laundry' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Franchise', 'item': 'https://cleanz24.com/laundry/franchise' },
          { '@type': 'ListItem', 'position': 3, 'name': cityName, 'item': `https://cleanz24.com/laundry/franchise/${citySlug}` },
          { '@type': 'ListItem', 'position': 4, 'name': serviceData.name, 'item': `https://cleanz24.com/laundry/franchise/${citySlug}/${serviceSlug}` }
        ]
      },
      {
        '@type': 'Service',
    ...
    <div className="city-service-wrapper">
      ...
      <section className="city-service-hero">
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <nav style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '20px' }}>
            <Link href="/laundry" style={{ color: '#16a34a', textDecoration: 'none', fontWeight: '500' }}>Home</Link>
            <span style={{ margin: '0 8px' }}>›</span>
            <Link href="/laundry/franchise" style={{ color: '#16a34a', textDecoration: 'none', fontWeight: '500' }}>Franchise</Link>
            <span style={{ margin: '0 8px' }}>›</span>
            <Link href={`/laundry/franchise/${citySlug}`} style={{ color: '#16a34a', textDecoration: 'none', fontWeight: '500' }}>{cityName}</Link>
            <span style={{ margin: '0 8px' }}>›</span>
      ...
      <section className="city-service-footer">
        <p style={{ fontSize: '0.95rem' }}>
          Back to the dedicated <Link href={`/laundry/franchise/${citySlug}`} style={{ color: '#16a34a', fontWeight: '600', textDecoration: 'none' }}>Cleanz24 {cityName} Franchise Page</Link>
        </p>
      </section>
    </div>
  );
