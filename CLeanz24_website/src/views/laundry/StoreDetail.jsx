...
import khararFacadeSignboard from '../../assets/cleanz24_kharar_facade_signboard.jpg';
import khararGlassEntranceReception from '../../assets/cleanz24_kharar_glass_entrance_reception.jpg';
import khararFabcareMachinesWall from '../../assets/cleanz24_kharar_fabcare_machines_wall.jpg';
import khararStorefrontEntranceRacks from '../../assets/cleanz24_kharar_storefront_entrance_racks.jpg';
...
// Kozhikode Kerala
import kozhikodeStorefront from '../../assets/cleanz24_kozhikode_storefront.jpeg';
import kozhikodeReception from '../../assets/cleanz24_kozhikode_reception.jpeg';
import kozhikodeLgMachines from '../../assets/cleanz24_kozhikode_lg_machines.jpeg';
import kozhikodeVacuumIron from '../../assets/cleanz24_kozhikode_vacuum_iron.jpeg';

// Bathinda Punjab
import bathindaStorefront from '../../assets/cleanz24_bathinda_storefront.jpg';
import bathindaInteriorReception from '../../assets/cleanz24_bathinda_interior_reception.jpg';
import bathindaGlassEntrance from '../../assets/cleanz24_bathinda_glass_entrance.jpg';
import bathindaSteamIroning from '../../assets/cleanz24_bathinda_steam_ironing.jpg';
import bathindaIronTablePress from '../../assets/cleanz24_bathinda_iron_table_press.jpg';

// Indirapuram Ghaziabad
import indirapuramSteamIroning from '../../assets/cleanz24_indirapuram_steam_ironing.jpg';
import indirapuramGarmentRacks from '../../assets/cleanz24_indirapuram_garment_racks.jpg';
import indirapuramReceptionDesk from '../../assets/cleanz24_indirapuram_reception_desk.jpg';
import indirapuramDrycleanerMachines from '../../assets/cleanz24_indirapuram_drycleaner_machines.jpg';
import indirapuramReceptionBranding from '../../assets/cleanz24_indirapuram_reception_branding.jpg';

// Vaikom Kerala
import vaikomStorefront from '../../assets/cleanz24_vaikom_storefront.jpg';
import vaikomLgMachinesShelving from '../../assets/cleanz24_vaikom_lg_machines_shelving.jpg';
import vaikomReceptionCounter from '../../assets/cleanz24_vaikom_reception_counter.jpg';
import vaikomGlassEntrance from '../../assets/cleanz24_vaikom_glass_entrance.jpg';
import vaikomSteamIroning from '../../assets/cleanz24_vaikom_steam_ironing.jpg';

// Noida Sector 137
import noidaSec137LgMachinesStaff from '../../assets/cleanz24_noida_sec137_lg_machines_staff.jpg';
import noidaSec137WallBranding from '../../assets/cleanz24_noida_sec137_wall_branding.jpg';
import noidaSec137ReceptionCounter from '../../assets/cleanz24_noida_sec137_reception_counter.jpg';
import noidaSec137SteamIroning from '../../assets/cleanz24_noida_sec137_steam_ironing.jpg';
import noidaSec137PackagingShelves from '../../assets/cleanz24_noida_sec137_packaging_shelves.jpg';

// Alibag Maharashtra
import alibagStorefrontWide from '../../assets/cleanz24_alibag_storefront_wide.jpg';
import alibagBuildingFacade from '../../assets/cleanz24_alibag_building_facade.jpg';
import alibagReceptionCounter from '../../assets/cleanz24_alibag_reception_counter.jpg';
import alibagReceptionStaff from '../../assets/cleanz24_alibag_reception_staff.jpg';
import alibagSteamIroning from '../../assets/cleanz24_alibag_steam_ironing.jpg';

// Panoor Kannur Kerala
import panoorStorefront from '../../assets/cleanz24_panoor_storefront.jpg';
import panoorReceptionCounter from '../../assets/cleanz24_panoor_reception_counter.jpg';
import panoorWashingMachines from '../../assets/cleanz24_panoor_washing_machines.jpg';
import panoorSteamIroning from '../../assets/cleanz24_panoor_steam_ironing.jpg';

// Una Himachal Pradesh
import unaReceptionDesk from '../../assets/cleanz24_una_reception_desk.jpg';
import unaReceptionLogoUpi from '../../assets/cleanz24_una_reception_logo_upi.jpg';
import unaInteriorLounge from '../../assets/cleanz24_una_interior_lounge.jpg';
import unaDrycleanersLgMachines from '../../assets/cleanz24_una_drycleaners_lg_machines.jpg';
import unaSteamIroning from '../../assets/cleanz24_una_steam_ironing.jpg';

// Kannur Kerala
import kannurReceptionGold from '../../assets/cleanz24_kannur_reception_gold.jpg';
import kannurStorefrontBuilding from '../../assets/cleanz24_kannur_storefront_building.jpg';
import kannurReceptionDesk from '../../assets/cleanz24_kannur_reception_desk.jpg';
import kannurPaperbagsShelving from '../../assets/cleanz24_kannur_paperbags_shelving.jpg';
import kannurInteriorWallBanners from '../../assets/cleanz24_kannur_interior_wall_banners.jpg';
import kannurReceptionBanner from '../../assets/cleanz24_kannur_reception_banner.jpg';
import kannurPosComputer from '../../assets/cleanz24_kannur_pos_computer.jpg';
import kannurLoungeSofa from '../../assets/cleanz24_kannur_lounge_sofa.jpg';
import kannurSignboardFrontage from '../../assets/cleanz24_kannur_signboard_frontage.jpg';
import kannurLgStackedMachines from '../../assets/cleanz24_kannur_lg_stacked_machines.jpg';
import kannurLgMachinesFront from '../../assets/cleanz24_kannur_lg_machines_front.jpg';
import kannurLgMachinesActive from '../../assets/cleanz24_kannur_lg_machines_active.jpg';
...
const STORE_IMAGES = {
  ...
  40: [
    ...
    kannurReceptionDesk,
    kannurPosComputer,
    kannurLgStackedMachines,
    kannurLgMachinesFront,
    kannurLgMachinesActive,
    kannurSteamIronedSarees,
    kannurTechnicalDuctsKarcher,
    kannurTechnicalPlumbing,
    kannurPaperbagsShelving,
    kannurLoungeSofa,
    kannurReceptionBanner,
    kannurInteriorWallBanners,
  ],
  53: [
    unaReceptionLogoUpi,
    unaDrycleanersLgMachines,
    unaReceptionDesk,
    unaInteriorLounge,
    unaSteamIroning,
  ],
  39: [
    panoorStorefront,
    panoorReceptionCounter,
    panoorWashingMachines,
    panoorSteamIroning,
  ],
  38: [
    alibagStorefrontWide,
    alibagBuildingFacade,
    alibagReceptionStaff,
    alibagReceptionCounter,
    alibagSteamIroning,
  ],
  2: [
    noidaSec137ReceptionCounter,
    noidaSec137WallBranding,
    noidaSec137LgMachinesStaff,
    noidaSec137PackagingShelves,
    noidaSec137SteamIroning,
  ],
  41: [
    vaikomStorefront,
    vaikomReceptionCounter,
    vaikomLgMachinesShelving,
    vaikomGlassEntrance,
    vaikomSteamIroning,
  ],
  7: [
    indirapuramReceptionDesk,
    indirapuramDrycleanerMachines,
    indirapuramReceptionBranding,
    indirapuramGarmentRacks,
    indirapuramSteamIroning,
  ],
  17: [
    bathindaStorefront,
    bathindaInteriorReception,
    bathindaGlassEntrance,
    bathindaSteamIroning,
    bathindaIronTablePress,
  ],
  44: [
    kozhikodeStorefront,
    kozhikodeReception,
  ...
  19: [
    khararFacadeSignboard,
    khararGlassEntranceReception,
    khararFabcareMachinesWall,
    khararStorefrontEntranceRacks,
    khararFacade,
    khararInterior,
    khararMachines,
    khararWardrobe,
...
const getServiceSlug = (title) => {
  ...
  if (t.includes('laundry')) return 'wash-and-fold';
  if (t.includes('dry')) return 'dry-cleaning';
  if (t.includes('shoe')) return 'shoe-cleaning';
  if (t.includes('leather')) return 'leather-cleaning';
  if (t.includes('curtain')) return 'curtain-cleaning';
  if (t.includes('carpet')) return 'carpet-cleaning';
...
export default function StoreDetail() {
  ...
  const isStoreLive = (s) => !s?.openingTime || new Date() >= new Date(s.openingTime);
  ...
  return (
    <div style={{ minHeight: '100vh', background: theme.bg, color: theme.text, fontFamily: "'Inter', sans-serif" }}>
      ...
      <section style={{ background: theme.primaryGrad, color: '#fff', padding: '110px 20px 60px', position: 'relative', overflow: 'hidden' }}>
        ...
        <section style={{ padding: '36px 20px', background: theme.bg, borderBottom: `1px solid ${theme.border}` }}>
          ...
          {lightbox && (
            ...
            >
              ...
              <div style={{ position: 'relative', width: '90vw', height: '85vh', borderRadius: '14px', boxShadow: '0 20px 80px rgba(0,0,0,0.8)', overflow: 'hidden' }} onClick={e => e.stopPropagation()}>
                <Image
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '20px' }}>
            {EXPERT_SERVICES.map((svc, idx) => {
              const svcSlug = getServiceSlug(svc.title);
              return (
                <Link
                  key={idx}
