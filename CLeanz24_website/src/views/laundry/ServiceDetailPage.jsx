          ...
          <div className="row align-items-center g-4">
            ...
            <div className="col-lg-5 text-center">
              <div className="p-4 rounded-4 shadow-lg position-relative" style={{ background: dark ? 'rgba(30, 41, 59, 0.8)' : '#ffffff', border: `1px solid ${dark ? 'rgba(255,255,255,0.1)' : '#e2e8f0'}`, backdropFilter: 'blur(10px)' }}>
                <Image src={service.icon} alt={service.title} width={180} height={180} className="img-fluid mb-3" style={{ maxHeight: '180px', width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 10px 15px rgba(0,0,0,0.15))' }} />
