    ...
    content: (
      <>
        ...
        <div style={{
          ...
          <Image src={blogLaundryWorkerHero} alt="Cleanz24 laundry worker in green t-shirt washing clothes professionally" fill style={{ objectFit: 'cover', objectPosition: 'center top', display: 'block' }} />
          <div style={{
            position: 'absolute',
            bottom: 0,
            left: 0,
    ...
    content: (
      <>
        ...
        <div style={{
          ...
          <Image src={blogPickupDeliveryHero} alt="Cleanz24 delivery rider in green t-shirt delivering laundry to doorstep" fill style={{ objectFit: 'cover', objectPosition: 'center', display: 'block' }} />
          <div style={{
            position: 'absolute',
            bottom: 0,
            left: 0,
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', overflow: 'hidden', aspectRatio: '16/9', backgroundColor: '#1A365D' }}>
        <Image src={post.image} alt={post.title} fill style={{ objectFit: 'cover', transition: 'transform 0.6s ease', transform: hovered ? 'scale(1.06)' : 'scale(1)', display: 'block' }} />
    ...
    <aside>
      ...
      <div style={cardStyle}>
        ...
        {recentPosts.map((post) => (
          ...
          >
            <Image src={post.image} alt={post.title} width={72} height={50} style={{ objectFit: 'cover', borderRadius: '8px', flexShrink: 0 }} />
            <div>
              <div
                style={{
                  fontSize: '13px',
