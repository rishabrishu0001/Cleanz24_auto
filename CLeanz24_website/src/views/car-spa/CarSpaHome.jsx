...
const firstVideo = '/assets/first_video.mp4';
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ backgroundImage: `url(${beforeDetailingImg?.src || beforeDetailingImg})` }}
      >
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url(${afterDetailingImg?.src || afterDetailingImg})`,
...
// 2. MAIN CAR SPA PAGE
function CarSpa() {
  const { isDarkMode, toggleTheme } = React.useContext(CarSpaThemeContext);
  ...
  return (
    <div className="d-flex flex-column min-vh-100 bg-primary-custom bg-carbon" id="home" style={{ overflowX: 'hidden' }}>
      ...
      <section className="hero-section position-relative text-center overflow-hidden" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
        ...
        >
          <source src={firstVideo?.src || firstVideo} type="video/mp4" />
        </video>
          ...
          <motion.div variants={fadeUpVariant} className="d-flex gap-3 justify-content-center flex-wrap">
            {memberData ? (
              <>
                ...
                <Link href="/car-spa/membership" className="btn btn-outline-primary-custom btn-lg rounded-pill px-5 py-3 fw-bold text-decoration-none">
                  View Plan Details
                </Link>
              </>
            ) : (
      ...
      <section className="py-5 bg-secondary-custom text-center border-bottom border-top" style={{ borderColor: 'var(--card-border)' }}>
        <div className="container py-5">
          ...
          <div className="d-flex justify-content-center mt-2 mb-5">
            <Player
              src={carwash3Url?.src || carwash3Url}
        ...
        <div className="container py-5 text-center">
          ...
          {!searchQuery && (
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpVariant}>
              <Link href="/car-spa/services" className="btn btn-glow px-5 py-3 fw-bold text-uppercase text-decoration-none">
                View All Stores
              </Link>
            </motion.div>
          )}
          ...
          <div className="row align-items-center g-5">
            <motion.div className="col-lg-6" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpVariant}>
              ...
              <div className="d-flex justify-content-center my-4">
                <Player
                  src={carwash1Url?.src || carwash1Url}
                  background="transparent"
                  speed={1}
