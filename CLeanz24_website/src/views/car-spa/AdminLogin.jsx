      ...
      >
        ...
        <div className="admin-login-padding" style={{ padding: '40px 36px 36px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <img src={logoImg?.src || logoImg} alt="Cleanz24" className="admin-login-logo" style={{ height: '56px', borderRadius: '10px', marginBottom: '14px', boxShadow: '0 4px 20px rgba(0,201,109,0.2)' }} />
