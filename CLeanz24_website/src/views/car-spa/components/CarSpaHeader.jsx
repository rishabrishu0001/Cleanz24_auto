...
export default function Header({ isDarkMode, toggleTheme }) {
  ...
  const [memberData, setMemberData] = useState(() => {
    try {
      const saved = typeof window !== 'undefined' ? localStorage.getItem('cleanz24_logged_in_member') : null;
    ...
    <>
      ...
      >
        <div className="container">
          <Link className="navbar-brand d-flex align-items-center text-decoration-none gap-2" href="/car-spa">
            <Image src={logoImg} alt="Cleanz24" className="me-1 navbar-logo" style={{ height: isScrolled ? '34px' : '40px', width: 'auto', transition: 'height 0.4s ease', objectFit: 'contain' }} />
          ...
          {isMobile ? (
            ...
            <div className="navbar-collapse justify-content-end d-none d-lg-flex">
              <div className="navbar-nav align-items-center">
                <Link className={`nav-link text-heading mx-xl-2 mx-xxl-3 fw-medium hover-brand ${isActive('/car-spa') ? 'active-link' : ''}`} href="/car-spa">Home</Link>
                <Link className={`nav-link text-heading mx-xl-2 mx-xxl-3 fw-medium hover-brand ${isActive('/car-spa/services') ? 'active-link' : ''}`} href="/car-spa/services">Services</Link>
                ...
                <Link className={`nav-link text-heading mx-xl-2 mx-xxl-3 fw-medium hover-brand ${isActive('/car-spa/franchise') ? 'active-link' : ''}`} href="/car-spa/franchise">Franchise</Link>
                <Link className={`nav-link text-heading mx-xl-2 mx-xxl-3 fw-medium hover-brand ${isActive('/car-spa/stores') ? 'active-link' : ''}`} href="/car-spa/stores">Stores</Link>
                <Link className={`nav-link text-heading mx-xl-2 mx-xxl-3 fw-medium hover-brand ${location.pathname.startsWith('/car-spa/blog') ? 'active-link' : ''}`} href="/car-spa/blog">Blog</Link>
                <Link className="nav-link text-heading mx-xl-2 mx-xxl-3 fw-medium hover-brand" style={{ color: 'var(--accent-color)' }} href="/">
                ...
                {isLoggedIn ? (
                  ...
                  <Link className="btn btn-glow btn-nav-cta px-3 px-xl-4 ms-lg-2 fw-bold text-decoration-none" href="/car-spa/membership">
          ...
          <>
            ...
            >
              ...
              <div className="mobile-panel-header">
                <Link href="/car-spa" onClick={() => setMobileMenuOpen(false)}>
                  <Image src={logoImg} alt="Cleanz24" style={{ height: '38px', width: 'auto', borderRadius: '6px', objectFit: 'contain' }} />
                </Link>
          ...
          <div className="pricing-matrix-modal-backdrop" onClick={() => setIsPricingModalOpen(false)}>
            ...
            >
                  ...
                  <div key={pkg.id} className="modal-package-row">
                    <div className="modal-package-info">
                      ...
                      <div className="modal-package-names">
                        <Link href={`/car-spa/packages/${pkg.id}`} className="modal-package-link" onClick={() => setIsPricingModalOpen(false)}>
                          {pkg.name}
                        </Link>
              ...
              <div className="modal-footer-custom">
                <Link href="/car-spa/book" className="btn btn-glow w-100 py-2 text-center text-decoration-none" onClick={() => setIsPricingModalOpen(false)}>
                  Book Appointment
                </Link>
              </div>
            </motion.div>
