      ...
      <div className="container pt-3">
        ...
        <div className="row mb-5 g-4">
          ...
          <div className="col-lg-4 mb-4 mb-lg-0">
            <Link className="navbar-brand d-flex align-items-center mb-4 text-decoration-none" href="/car-spa">
              <Image src={logoImg} alt="Cleanz24" height={60} className="me-2" style={{ width: 'auto', objectFit: 'contain' }} />
          ...
          <div className="col-lg-2 col-md-4 col-6">
            ...
            <ul className="list-unstyled footer-links">
              <li><Link href="/car-spa" className="text-muted-custom text-decoration-none hover-brand">Home</Link></li>
              <li><Link href="/car-spa/services" className="text-muted-custom text-decoration-none hover-brand">Services</Link></li>
              <li><Link href="/car-spa/book" className="text-muted-custom text-decoration-none hover-brand">Book Now</Link></li>
              <li><Link href="/car-spa/blog" className="text-muted-custom text-decoration-none hover-brand">Blog</Link></li>
              <li><Link href="/car-spa/franchise" className="text-muted-custom text-decoration-none hover-brand">Franchise</Link></li>
            </ul>
          </div>
          ...
          <div className="col-lg-2 col-md-4 col-6">
            ...
            <ul className="list-unstyled footer-links">
              <li><Link href="/car-spa/services" className="text-muted-custom text-decoration-none hover-brand">Foam & Pressure Wash</Link></li>
              <li><Link href="/car-spa/services" className="text-muted-custom text-decoration-none hover-brand">Deep Detailing</Link></li>
              <li><Link href="/car-spa/services" className="text-muted-custom text-decoration-none hover-brand">Ceramic Coating</Link></li>
