      ...
      <div className="container pt-3">
        ...
        <div className="row mb-5 g-4">
          ...
          <div className="col-lg-2 col-md-4 col-6">
            ...
            <ul className="list-unstyled footer-links">
              ...
              <li><Link to="/car-spa/blog" className="text-muted-custom text-decoration-none hover-brand">Blog</Link></li>
        ...
        <div className="border-top pt-4 d-flex flex-column flex-md-row justify-content-between align-items-center" style={{ borderColor: 'var(--card-border) !important' }}>
          ...
          <div className="d-flex gap-3">
            <Link to="/laundry/privacy-policy" className="text-muted-custom text-decoration-none small hover-brand">Privacy Policy</Link>
            <Link to="/laundry/terms-of-service" className="text-muted-custom text-decoration-none small hover-brand">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
