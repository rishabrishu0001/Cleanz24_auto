...
export default function AboutUs() {
  return (
    <div>
      <SEOMeta
        title="About Us — Cleanz24 | India's Leading Laundry & Dry Cleaning Chain"
        description="Learn about Cleanz24 — India's fastest growing laundry, dry cleaning & car spa franchise network. 100+ stores, 17+ states, 2 lakh+ happy customers. Our story, values & mission."
        keywords="about Cleanz24, laundry franchise India, dry cleaning brand, Cleanz24 history, laundry chain India"
        canonical="https://cleanz24.com/laundry/about-us"
      />
      ...
      <section className="py-5 text-center" style={{ background: 'linear-gradient(135deg, #1a7a2e 0%, #0f5520 100%)' }}>
        <div className="container py-4">
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link to="/laundry/franchise" className="btn-primary-custom px-5 py-3 fs-5"
