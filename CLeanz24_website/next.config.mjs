...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/laundry/franchise', destination: '/best-laundry-drycleaning/franchise-opportunities', permanent: true },
      ...
      { source: '/franchise', destination: '/best-laundry-drycleaning/franchise-opportunities', permanent: true },
      { source: '/franchise-opportunities', destination: '/best-laundry-drycleaning/franchise-opportunities', permanent: true },
      { source: '/best-laundry-franchise', destination: '/best-laundry-drycleaning/franchise-opportunities', permanent: true },
      { source: '/laundry-franchise', destination: '/best-laundry-drycleaning/franchise-opportunities', permanent: true },
